...
class Daemon:
    ...
    def _pre_configure(self):
        ...
        if self._client_config:
            ...
            # The client UID is no longer self-generated here: it is derived
            # from the client certificate's Common Name (server-assigned at
            # pairing) by the client service. An unpaired client simply has no
            # UID until it pairs.
